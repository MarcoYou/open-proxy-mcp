...
def register_tools(mcp):
    ...
    async def law_lookup(
        ...
        또는 법령 조문번호·키워드 → 조문 전문 + 관련 정관 변경유형·우회 시나리오·주총 안건신호. 상법·자본시장법·
        공정거래법·외부감사법 + **금융회사 지배구조법·상증세법·금융지주회사법·금산법·은행법·보험업법**
        (각 법률+시행령, 260902 확장) 원문(legalize-kr)을 인덱싱. **회사·DART
        ...
        **범위 밖은 조문을 붙이지 않는다** — 거래소 상장규정·공시규정·업무규정(관리종목·상장폐지·실질심사·
        ...
        law: 법령 필터 "" (전체) | 상법 | 자본시장법 | 공정거래법 | 외부감사법 | 지배구조법 | 상증세법 | 금융지주회사법 | 금산법 | 은행법 | 보험업법 (시행령 포함). 확장 6법은 질의가 그 영역을 가리킬 때(금융회사·은행·보험·지주·상속·증여 등) 앞세우고, 아니면 4법을 먼저 본다 — 넓힌 대가로 옛 질의 정확도가 떨어지는 것을 막는 장치다.
