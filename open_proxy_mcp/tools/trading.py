...
def register_tools(mcp):
    ...
    async def trading_data(company: str = "", scope: str = "firm", format: str = "md",
                           as_of: str = "", since: str = "", scheme: str = "중분류",
