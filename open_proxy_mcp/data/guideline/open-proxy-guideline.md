...
| 사외이사 5년 룰·6년 초과 재직 §2.4 against ①·② | 강행 against (§542의8) | **REVIEW** — 5년은 OPM 자체 소프트 조기경보(성문 규정 없음), 6년 초과는 상법 시행령 §34⑤7호 결격 **가능**. 재직기간이 하한 추정(과소계상)이고 동일회사/계열 합산(9년)을 못 갈라 결격을 확정하지 않는다(260710 법률 정정). 감사위원도 같은 문턱 |
...
`OPM Guideline §2.4 이사 선임 — against ①「사외이사 5년 룰」… ▸ 엔진: …` 처럼 **이 문서의 절 번호와
