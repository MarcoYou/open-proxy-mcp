...
#: **법 이름**으로 걸러야 하는 자리다.
#:
#: ★ 여기 실린 법을 나중에 corpus 에 넣으면 **그 줄을 지운다.** 안 지우면 코퍼스에 있는데도
#:   「범위 밖」이라고 답한다 — 있는 것을 없다고 말하는 쪽이 더 나쁘다.
_OUT_OF_CORPUS_STATUTES: dict[str, str] = {
    # 금융업권 — 은행·보험·금융지주 지배구조와 자회사 규제의 진짜 근거
    "보험업법": "보험업법 (이 도구는 안 읽는다)",
    "은행법": "은행법 (이 도구는 안 읽는다)",
    "금융지주회사법": "금융지주회사법 (이 도구는 안 읽는다)",
    "금융산업의구조개선에관한법률": "금융산업의 구조개선에 관한 법률(금산법)",
    "금산법": "금융산업의 구조개선에 관한 법률",
    "금융회사의지배구조에관한법률": "금융회사의 지배구조에 관한 법률",
    "지배구조법": "금융회사의 지배구조에 관한 법률",
    "여신전문금융업법": "여신전문금융업법 (이 도구는 안 읽는다)",
    # 세법 — 지배구조 재편·승계 논의에서 자주 닿는다
    "상속세및증여세법": "상속세 및 증여세법 (이 도구는 안 읽는다)",
    "상증세법": "상속세 및 증여세법",
    "상속세": "상속세 및 증여세법",
    "증여세": "상속세 및 증여세법",
    ...
    # 법 **이름**을 대지 않고 그 법의 **용어**로 묻는 경우. 이름만 막으면 「보험회사의 자산운용
    #   한도」처럼 물었을 때 그대로 새어 나간다(260902 실측). 4법에도 나오는 말은 넣지 않는다 —
    #   예: 「대주주 신용공여」는 상법 §542-9 에도 있고, 「일감몰아주기」는 공정거래법에 있다.
    "지급여력": "보험업법 (지급여력비율)",
    "책임준비금": "보험업법",
    "방카슈랑스": "보험업법 시행령",
    "자산운용비율": "보험업법 (자산운용 한도)",
    "자산운용한도": "보험업법 (자산운용 한도)",   # 공백은 normalize 가 지운다
    "보험회사의자산운용": "보험업법",
    "적기시정조치": "금융산업의 구조개선에 관한 법률",
    "동일차주": "은행법 (동일차주 신용공여 한도)",
    "할증평가": "상속세 및 증여세법 (최대주주 할증평가)",
    "명의신탁": "상속세 및 증여세법 (명의신탁 증여의제)",
    "증여의제": "상속세 및 증여세법",
}
