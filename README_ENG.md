...
[![Release](https://img.shields.io/badge/release-v2.3-blue.svg)](docs/RELEASE_NOTES_ENG.md)
...
Plus source tracing, corporate governance reports, dilutive issuance (rights/CB), restructuring (mergers/splits), stake deals, and bidirectional articles↔statute lookup — **25 tools in total**.
