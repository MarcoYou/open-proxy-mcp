...
- Net income/equity are **controlling-interest**, statements **consolidated-first**. Non-KRW functional-currency firms (e.g. USD) are **auto-converted at Bank of Korea (ECOS) rates** (e.g. Example Company BP).
...
> "What's Example Company BP's PBR?"
>
