...
- **Treasury shares**: matches the buy → dispose → cancel cycle. **The purchase itself is what counts** — cash already left the company at the point of purchase, so whether it's later formally cancelled is just bookkeeping and doesn't change the substance of the return (holding without cancelling already counts). Instead it distinguishes a **freshly-purchased** buyback from one that's just processing shares acquired years earlier (i.e., whether new cash was actually committed).
