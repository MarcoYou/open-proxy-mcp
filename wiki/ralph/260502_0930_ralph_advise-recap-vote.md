...
학습 데이터:
- **8 운용사**: m_legacy / s_legacy / sa_active / k_legacy / t_activist / a_activist / b_foreign / c_activist (2024-04 + 2025-04 + 2026-04, 총 12,949 votes)
...
**비교 표 (audit 페이지에 작성)**:
| 회사 | 안건 | N연기금 | M레거시 | S레거시 | SA액티브 | K레거시 | T행동 | A행동 | C행동 | B외국 | OPM advise (vote_style별) | 일치 |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
