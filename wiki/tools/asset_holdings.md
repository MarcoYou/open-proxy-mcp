...
**전수조사 + 5인 패널(재무·부동산·공시전문가·가치투자자·Data QA) 검토로 확정한 설계**:
...
4. **동의어를 넓히면 오탐이 따라온다 — 넓힌 뒤 반드시 오탐 회귀검증을 한다.** 지분증권 쪽을 넓힌
   변경이 K-IFRS 9 매출채권 손상충당금 표까지 끌어왔고, 두 표에서만 쓰이는 고유 용어로 배제를 걸어
   풀었다(원래 목표는 유지, 신규 오탐만 제거).
