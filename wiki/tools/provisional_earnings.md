...
- **속도**: 반기보고서(~45일 뒤)·분기보고서보다 훨씬 빠름. 예: 예시기업 CW 2026 2Q(6/30 종료) → 7/7 잠정공시.
...
- **비재무형 = 도메인 실적표**(표준 매출/영업이익 표는 '-', 별도 도메인표): 자동차(예시기업 HM·예시기업 AV·예시기업 U=판매대수) · 조선(예시기업 K·예시기업 H=수주 백만불) · 유틸리티(예시기업 GR·지역난방=판매량) · 카지노(예시기업 GI·예시기업 E·예시지주 D관광=카지노매출 테이블/머신) · **예시기업 EN(지역별 매출=한국/중국/베트남/러시아 법인별)**. 전부 `table_markdown`이 도메인 데이터를 정확히 담음 → 호출측 AI가 읽음.
...
- 2026-09-07: **라벨 파생 정정.** 결산월을 실적기간 시작월에서 추정하던 것(`start.month - 1`)을 회사정보 `acc_mt` 로 —
  예시기업 CW 2025.07~09 이 「2026 사업연도 1분기 · 6월 결산」으로 나가던 결함. 한 달짜리 기간(예시기업 HM·예시기업 AV·예시기업 K 월별
  실적)은 `month` 로 「2026년 4월(월간)」. 둘째 줄에 공시일과 실적기간을 나란히. 창 안 최신이 `[첨부정정]` 이면 본문이
  없어 다음 후보로(예시기업 X 2025.07 창이 「원문 파싱 실패」였음). 날짜 범위 없는 원문(예시기업 CW·예시기업 X 2025.07)은 「2025년 2분기」
