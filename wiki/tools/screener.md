...
> "지난주 업종별 수주, 평소보다 많이 떴나" → `view="흐름"` (기본 유형 수주, 기본 기간 원장 최신일까지 최근 7일).
...
- **기간 말**: 기본은 원장 최신일까지 7일. 「올해」「이번 주」는 원장 최신일 기준, **「이번 달」「지난달」은 오늘 기준
  달력의 달**(260918) — 지난달 = 지난달 1일~말일, 이번 달 = 1일~원장 최신일. 원장 최신일 기준으로 잡으면 월초 밤 배치
  전에 「지난달」이 두 달 전이 된다. 월초라 원장이 아직 이번 달에 없으면 가장 최근 달을 보이고 밝힌다.
  카드 보기(공용 기간 해석기)의 「지난달」은 **최근 30일**이다 — 같은 말이 보기마다 다르다. 「지난 한 달」「최근 30일」은
  두 보기 모두 굴러가는 30일.
...
## 변경 이력
- 2026-09-18: 흐름 보기 기간에 **「이번 달」「지난달」** — 오늘 기준 달력의 달. 종전엔 「이번 달」을 못 알아들어 7일로,
  「지난달」은 공용 해석기가 최근 30일로 읽었다.
