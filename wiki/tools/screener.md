...
- `types`: `core`(디폴트) / `all` / 쉼표구분 코드. period: today / yesterday / **since_yesterday**(디폴트) /
  last_7d / last_30d / **prev_week**(달력의 지난주 월~일) / **prev_month**(지난달 1일~말일) / custom.
...
| 절 | 무엇 |
|---|---|
| 업종별 흐름 (WICS 대분류·중분류) | 새 공시 건수, 평소(직전 N주를 같은 일수로 환산), 평소 대비 배수, 금액 합(확인 건수), 수주는 평균 매출 대비 %·해지, 그 밖의 유형은 세부 구성, 정정 건수 |
...
- **기간 말**: 기본은 원장 최신일까지 7일. 「올해」「이번 주」는 원장 최신일 기준, **「이번 달」「지난달」「지난주」는
  오늘 기준 달력**(260918) — 지난주 = 지난주 월~일, 지난달 = 지난달 1일~말일, 이번 달 = 1일~원장 최신일. 원장 최신일
  기준으로 잡으면 월초·주초 밤 배치 전에 한 칸 더 앞이 된다. 월초라 원장이 아직 이번 달에 없으면 가장 최근 달을 보이고
  밝힌다. 「지난주」「지난달」은 카드 보기와 같은 공용 해석기(`calendar_window`)라 두 보기의 뜻이 같다.
  굴러가는 창은 「지난 일주일」「최근 7일」「지난 한 달」「최근 30일」.
...
| "지난주" · "지난달" — **달력**의 지난주 월~일 · 지난달 1일~말일(260918) | `prev_week` · `prev_month` |
| "지난 일주일" · "일주일" · "최근 7일" — 굴러가는 7일 | `last_7d` · `custom:7` |
| "지난 한 달" · "최근 3개월" · "최근 45일" — 굴러가는 창 | `last_30d` · `custom:90` · `custom:45` |
