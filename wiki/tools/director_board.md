...
- **소진율 >100%는 버그 아닌 실제 신호일 수 있음**: 수정 후에도 300개사 중 14개사가 100% 초과
  (HD현대중공업 125.7% 등 조선·해운·철강 슈퍼사이클 회사 다수) — 원문 재확인(HD현대중공업 2025:
  등기이사 2명에 50.3억 지급, 승인한도 40억) 결과 **실제로 사전승인 한도를 초과 지급**한 진짜
  사례. `utilization_flag="exceeded_limit"`로 별도 표시(90%+ "high"와 구분) — 스튜어드십 관점에서
  가장 유용한 신호 중 하나.
