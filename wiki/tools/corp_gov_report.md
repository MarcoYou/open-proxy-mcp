...
- `tables`: 서식 표 원본 4종 (표 1-2-2 안건별 찬반 주식수 · 4-3-1 이사후보 사전 정보제공기간 ·
  5-2-1 사외이사 겸직 · 7-2-1 개별이사 3개년 출석률·찬성률). 이미 받아 둔 원문에서 뽑아 DART 콜 0 증가.
...
## 알려진 issue + TODO
- 서식 표 32종 중 4종만 노출 (나머지 28종 TODO — 이사회 구성·위원회·배당·주주제안 등).
