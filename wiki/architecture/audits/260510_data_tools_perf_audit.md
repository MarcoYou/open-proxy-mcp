...
- 2026-05-24 후속 fix 후 빠른 축: `company` 182-386ms, `shareholder_meeting_notice` 372-519ms, `financial_metrics` 374-412ms, `ownership_structure` 382-453ms.
- 후속 fix 후 느린 축: `dividend` 0.99-1.59s, `treasury_share` 0.70-0.96s.
...
이번 audit에서 실제로 반영된 성능 개선은 7건입니다.
