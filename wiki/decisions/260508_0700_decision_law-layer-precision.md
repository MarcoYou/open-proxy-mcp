...
2. 안건 title 이 일반 표현이면 사전 우회(예시기업 FW 2025 유형)를 잡지 못한다
...
| reason | "정관변경에서 이사 선임 방법/정원 관련 조항 변경 — 집중투표·분리선출 사전 우회 의심 (예시기업 FW 2025 사례). 본문 변경 내용 직접 확인 필수" |
...
분쟁 회사에서 B1-4b 8건 폭발 (예시기업 EL 6 + 예시기업 HK + 예시기업 HT) — 분쟁 시그널 매우 효과적.

### 회귀 안전성

재분류: 209 unique hits 중 변경 3건 / 유지 206건 — 모두 정확 향상.
- 예시기업 DC + 예시기업 HK: B1-4 → B1-4b
- 예시기업 GP: B1-8b → B1-7 (더 specific reason)
...
- (+) sentence 우회 catch (B1-8b — 예시기업 FW 사전 우회)
