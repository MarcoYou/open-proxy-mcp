...
- **매트릭스 시스템 문서**: `open-proxy-mcp/architecture/matrix-system.md` (구 `decision-matrix-design` + `matrix-auto-scoring` 통합)
- **토론 시뮬레이션 Transcript**: `open-proxy-mcp/decisions/260429_0059_debate_opm-guideline-7전문가.md`

### 8.3 관련 위키
- 합의 매트릭스: `open-proxy-mcp/decisions/260429_0059_decision_voting-policy-consensus-matrix.md`
- 12 카테고리 도메인 위키: `open-proxy-mcp/rules/concepts/`
