...
- [x] 프론트엔드 접이식 카드 UI
- [x] 세부의안 번호 매핑 — <p> 헤더에서 감지 (LG화학 패턴)
- [x] agm_agenda 세부의안 전달 (parse_aoi sub_agendas 파라미터)
...
- [x] 경력 내용 분리 — 법인격 패턴 (주)/(재)/법무법인 앞에서 split
- [ ] DART 원본에서 공백 없이 합쳐진 일부 케이스 (회계법인 등) 추가 대응
