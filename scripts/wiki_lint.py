...
CATEGORY_LABEL = re.compile(r"(?:^#{2,3} |\*\*)(Company|Screening|Meeting|Data|Evidence|Action|참조|Tools)\s*\((\d+)", re.MULTILINE)
...
def check_index_counts(pages) -> list[str]:
    ...
    cats = ("Company", "Screening", "Meeting", "Data", "Evidence", "Action", "참조")
