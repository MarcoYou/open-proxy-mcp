...
[![Tools](https://img.shields.io/badge/tools-28-orange.svg)](#tool-구조-28개)
...
그 외 출처 추적, 기업지배구조보고서, 희석 이벤트(증자/CB), 구조개편(합병/분할), 지분 인수·매각, 정관↔법령 양방향 조회, 의결권 정책 원문 조회 등 **총 28개 tool**을 제공합니다.
