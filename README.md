...
[![Release](https://img.shields.io/badge/release-v2.7.1-blue.svg)](docs/RELEASE_NOTES.md)
...
먼저 `[분석할 회사명] 회사 정보와 최근 공시 3건을 보여줘`에서 대괄호 부분을 실제 회사명으로 바꿔 물어보세요. 회사와 공시 목록이 나오면 연결된 것입니다. 도구 이름을 알 필요 없이 이어서 질문할 수 있습니다.
...
아래 회사명은 익명 예시입니다. 실제 분석할 회사명이나 종목코드로 바꿔 질문하세요.

<details open>
<summary><b>🗳️ 주주총회·의결권이 궁금할 때</b></summary>

> - 예시기업 Y 다음 정기 주주총회 안건과 안건별 의결권 의견을 근거와 함께 알려줘
> - 예시기업 FP 이번 주총 이사 선임 안건, 후보별로 짚어야 할 점이 뭐야?
> - 예시기업 CW 작년 주총 안건이 실제로 어떻게 표결됐어?
...
> - 예시기업 CW 최근 3년 실적과 향후 2개년 컨센서스를 비교해줘
> - 예시기업 AL 분기 실적 추세를 영업현금흐름까지 같이 보여줘
> - 예시기업 HM 잠정실적 나온 거 있어? 확정치랑 무엇이 달라?
> - 예시기업 Y 수익성을 듀퐁 분해로 뜯어줘
...
> - 분석할 회사의 PER·PBR이 과거 대비 어느 수준이야?
> - 예시기업 AB 내년·내후년 추정치로 포워드 PER 을 계산해줘
> - 예시기업 CW 2024년 말 시점의 밸류에이션은 어땠어?
...
> - 예시기업 HF이 무엇으로 돈을 벌어? 사업부문별로 나눠줘
> - 예시기업 AQ 가동률과 원재료 가격 추이 알려줘
> - 예시기업 GE이 들고 있는 계열사 지분과 잉여자산 가치를 계산해줘
> - 이 회사 수주잔고가 얼마나 남았어?
...
> - 예시기업 CQ 최대주주와 특수관계인 지분 알려줘
> - 예시기업 S 최근 3년 배당 추이와 배당성향을 보여줘
...
- **후보가 여럿이면 되묻습니다** — 「예시기업 GU」처럼 겹치는 이름은 고르기 전까지 다음 조회로 넘어가지 않습니다.
- **기간과 대상은 말로 주면 됩니다** — 「이번 주」「지난달」「3분기」「8월 1일부터 8월 20일까지」, 「코스피 시가총액 상위 200개 기업」「예시기업 CW, 예시기업 AL」. 「지난주」「지난달」은 달력의 주·달이고, 「최근 7일」「최근 30일」은 오늘을 포함한 날수입니다.
...
자료가 일부만 나오거나 같은 질문을 반복하게 된다면 [도구 연결·추가 조회·오류 대응 안내](docs/TOOL_CALLING.md)를 보세요.
...
| **사업연도는 결산월을 따릅니다** | 12월 결산이 아닌 회사는 달력 연도와 어긋납니다. 예시기업 DO(001720)의 `2025-06-30` 은 FY2026-Q1 입니다 |
...
- **종류주식이 보통주 배당을 덮던 문제**(2026-09-06 수정) — 「우선주」 글자가 없는 종류주식 표기
  ...
  예시기업 GS FY2024 는 보통주 3,980원이 「1종 종류주식」 4,042원으로, 예시기업 BN은 2,000원이 2,050원으로
