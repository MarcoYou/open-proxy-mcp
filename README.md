...
[![Tools](https://img.shields.io/badge/tools-26-orange.svg)](#tool-구조-26개)
...
그 외 출처 추적, 기업지배구조보고서, 희석 이벤트(증자/CB), 구조개편(합병/분할), 지분 인수·매각, 정관↔법령 양방향 조회, 의결권 정책 원문 조회 등 **총 26개 tool**을 제공합니다.
...
**어느 해 재무제표로 판단하나** — 자본잠식·배당재원 같은 회사 상태는 **승인 대상 연도**로 봅니다. 주총일 시점에 그 해 사업보고서가 이미 제출돼 있으면 확정치(**FY2025A**)를, 아직이면 소집공고에 실린 잠정치(**FY2025P**)를, 둘 다 없으면 직전 확정치를 씁니다. 기준일이 주총일이라 그때 알 수 없던 정보는 쓰지 않습니다. 잠정치로 판단한 경우 그 사실이 문장에 표시되며, 관리종목 판정은 감사 후 재무제표 기준이라 잠정치로는 규정 판정을 내리지 않습니다.
