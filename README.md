...
- **[전체시장 공시 디제스트](wiki/tools/screener.md)**: 전체시장에 뜬 수주·자사주·배당·증자·주총소집·5%지분 공시를 한 번에 훑어 카드형(기업·시총·유형·단계·정정·분모%·링크)으로 요약합니다. 유니버스(전체·코스피·코스닥·시총상위 N·종목 지정)로 좁혀 매일 아침 공시 알람 루틴으로 쓸 수 있습니다 ([루틴 레시피](docs/routines/screener-morning-digest.md)).
